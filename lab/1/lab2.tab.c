...
{
       0,    60,    60,    61,    62,    63,    65,    67,    68,    69,
      70,    71,    72,    73,    74,    76,    78,    80,    82,    84,
      86,    89,    90,    91,    92,    94,    95,    96,    97,    98,
      99,   100,   101,   102,   103,   104,   130,   132,   133,   134,
     135,   136,   137,   138,   139,   140,   141,   142,   143,   144,
     145,   171,   172,   173,   200,   201,   202,   203,   204,   205,
     206,   207,   208,   210,   211,   213,   214,   215,   216,   217,
     218,   220,   221,   222,   224,   226,   228,   229,   231,   232,
...
{
  "$end", "error", "$undefined", "INTEGER_LITERAL", "EQ", "DIV", "MUL",
  "PLUS", "MINUS", "SEMICOLON", "LEFTCURLBRAC", "RIGHTCURLBRAC",
  "LEFTBRAC", "RIGHTBRAC", "LEFTSQBRAC", "RIGHTSQBRAC", "COMMA", "QUES",
  "NOT", "AND", "OR", "NEQ", "LEQ", "DOT", "IDENTIFIER", "CLASS", "PUBLIC",
  "STATIC", "VOID", "MAIN", "STRING", "SOP", "EXTENDS", "RETURN",
  "INTTYPE", "BOOL", "IF", "ELSE", "WHILE", "THIS", "NEW", "HDEF", "DLEN",
  "TR", "FL", "$accept", "Goal", "MainClass", "TypeDeclaration",
  "MethodDeclaration", "Type", "Statement", "Expression",
  "PrimaryExpression", "MacroDefinition", "MacroDefStatement",
  "MacroDefExpression", "Identifier", "Integer", "STARONE", "STARTWO",
  "STARTHREE", "STARFOUR", "STARFIVE", "STARSIX", "STARSEVEN", "STAREIGHT", YY_NULLPTR
};
#endif
...
#line 1545 "lab2.tab.c"
    break;

  case 3:
#line 61 "lab2.y"
                                    {sprintf((yyval.char_val),"%s\n",(yyvsp[0].char_val)); printf("%s\n",(yyval.char_val));}
#line 1551 "lab2.tab.c"
    break;

  case 4:
#line 62 "lab2.y"
                                    {sprintf((yyval.char_val),"%s %s\n",(yyvsp[-1].char_val),(yyvsp[0].char_val)); printf("%s\n",(yyval.char_val));}
#line 1557 "lab2.tab.c"
    break;

  case 5:
#line 63 "lab2.y"
                                                {sprintf((yyval.char_val),"%s %s\n",(yyvsp[-1].char_val),(yyvsp[0].char_val)); printf("%s\n",(yyval.char_val));}
#line 1563 "lab2.tab.c"
    break;
...
#line 1593 "lab2.tab.c"
    break;

  case 11:
#line 71 "lab2.y"
                                                                                        {sprintf((yyval.char_val),"%s %s %s %s %s %s",(yyvsp[-5].char_val),(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1599 "lab2.tab.c"
    break;
...
#line 1605 "lab2.tab.c"
    break;

  case 13:
#line 73 "lab2.y"
                                                                                                {sprintf((yyval.char_val),"%s %s %s %s %s %s %s",(yyvsp[-6].char_val),(yyvsp[-5].char_val),(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1611 "lab2.tab.c"
    break;
...
#line 1641 "lab2.tab.c"
    break;

  case 19:
#line 84 "lab2.y"
                                                                                                                                                     {sprintf((yyval.char_val),"%s %s %s %s %s %s %s %s %s %s %s %s %s",(yyvsp[-12].char_val),(yyvsp[-11].char_val),(yyvsp[-10].char_val),(yyvsp[-9].char_val),(yyvsp[-8].char_val),(yyvsp[-7].char_val),(yyvsp[-6].char_val),(yyvsp[-5].char_val),(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1647 "lab2.tab.c"
    break;
...
#line 1653 "lab2.tab.c"
    break;

  case 21:
#line 89 "lab2.y"
                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1659 "lab2.tab.c"
    break;

  case 22:
#line 90 "lab2.y"
                        {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1665 "lab2.tab.c"
    break;

  case 23:
#line 91 "lab2.y"
                                                {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1671 "lab2.tab.c"
    break;

  case 24:
#line 92 "lab2.y"
                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1677 "lab2.tab.c"
    break;

  case 25:
#line 94 "lab2.y"
                                        {sprintf((yyval.char_val),"%s %s",(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1683 "lab2.tab.c"
    break;

  case 26:
#line 95 "lab2.y"
                                                        {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1689 "lab2.tab.c"
    break;

  case 27:
#line 96 "lab2.y"
                                                                {sprintf((yyval.char_val),"%s %s %s %s %s",(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1695 "lab2.tab.c"
    break;

  case 28:
#line 97 "lab2.y"
                                                        {sprintf((yyval.char_val),"%s %s %s %s",(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1701 "lab2.tab.c"
    break;

  case 29:
#line 98 "lab2.y"
                                                                                        {sprintf((yyval.char_val),"%s %s %s %s %s %s %s",(yyvsp[-6].char_val),(yyvsp[-5].char_val),(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1707 "lab2.tab.c"
    break;

  case 30:
#line 99 "lab2.y"
                                                                {sprintf((yyval.char_val),"%s %s %s %s %s",(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1713 "lab2.tab.c"
    break;

  case 31:
#line 100 "lab2.y"
                                                                                {sprintf((yyval.char_val),"%s %s %s %s %s %s %s",(yyvsp[-6].char_val),(yyvsp[-5].char_val),(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1719 "lab2.tab.c"
    break;

  case 32:
#line 101 "lab2.y"
                                                                {sprintf((yyval.char_val),"%s %s %s %s %s",(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1725 "lab2.tab.c"
    break;
...
#line 1768 "lab2.tab.c"
    break;

  case 36:
#line 130 "lab2.y"
                                                {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1774 "lab2.tab.c"
    break;

  case 37:
#line 132 "lab2.y"
                                                        {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1780 "lab2.tab.c"
    break;

  case 38:
#line 133 "lab2.y"
                                                        {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1786 "lab2.tab.c"
    break;

  case 39:
#line 134 "lab2.y"
                                                        {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1792 "lab2.tab.c"
    break;

  case 40:
#line 135 "lab2.y"
                                                        {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1798 "lab2.tab.c"
    break;

  case 41:
#line 136 "lab2.y"
                                                                {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1804 "lab2.tab.c"
    break;

  case 42:
#line 137 "lab2.y"
                                                                {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1810 "lab2.tab.c"
    break;

  case 43:
#line 138 "lab2.y"
                                                                {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1816 "lab2.tab.c"
    break;

  case 44:
#line 139 "lab2.y"
                                                                {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1822 "lab2.tab.c"
    break;

  case 45:
#line 140 "lab2.y"
                                                                                {sprintf((yyval.char_val),"%s %s %s %s",(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1828 "lab2.tab.c"
    break;

  case 46:
#line 141 "lab2.y"
                                                {sprintf((yyval.char_val),"%s %s",(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1834 "lab2.tab.c"
    break;

  case 47:
#line 142 "lab2.y"
                                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1840 "lab2.tab.c"
    break;
...
#line 1926 "lab2.tab.c"
    break;

  case 54:
#line 200 "lab2.y"
                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1932 "lab2.tab.c"
    break;

  case 55:
#line 201 "lab2.y"
                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1938 "lab2.tab.c"
    break;

  case 56:
#line 202 "lab2.y"
                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1944 "lab2.tab.c"
    break;

  case 57:
#line 203 "lab2.y"
                                        {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1950 "lab2.tab.c"
    break;

  case 58:
#line 204 "lab2.y"
                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1956 "lab2.tab.c"
    break;

  case 59:
#line 205 "lab2.y"
                                                                         {sprintf((yyval.char_val),"%s %s %s %s %s",(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1962 "lab2.tab.c"
    break;

  case 60:
#line 206 "lab2.y"
                                                                 {sprintf((yyval.char_val),"%s %s %s %s",(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1968 "lab2.tab.c"
    break;

  case 61:
#line 207 "lab2.y"
                                                 {sprintf((yyval.char_val),"%s %s",(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1974 "lab2.tab.c"
    break;

  case 62:
#line 208 "lab2.y"
                                                         {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 1980 "lab2.tab.c"
    break;

  case 63:
#line 210 "lab2.y"
                                        {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1986 "lab2.tab.c"
    break;

  case 64:
#line 211 "lab2.y"
                                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 1992 "lab2.tab.c"
    break;
...
#line 2028 "lab2.tab.c"
    break;

  case 71:
#line 220 "lab2.y"
                                                                                        {store((yyvsp[-5].char_val),(yyvsp[-1].char_val),""); sprintf((yyval.char_val),"%s %s %s %s %s %s %s",(yyvsp[-6].char_val),(yyvsp[-5].char_val),(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2034 "lab2.tab.c"
    break;

  case 72:
#line 221 "lab2.y"
                                                                                                        {store((yyvsp[-6].char_val),(yyvsp[-1].char_val),(yyvsp[-4].char_val)); sprintf((yyval.char_val),"%s %s %s %s %s %s %s %s",(yyvsp[-7].char_val),(yyvsp[-6].char_val),(yyvsp[-5].char_val),(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2040 "lab2.tab.c"
    break;

  case 73:
#line 222 "lab2.y"
                                                                                                                {char* temp=(char*)malloc(strlen((yyvsp[-5].char_val))+strlen((yyvsp[-4].char_val))+1);strcpy(temp,(yyvsp[-5].char_val));strcat(temp,(yyvsp[-4].char_val));store((yyvsp[-7].char_val),(yyvsp[-1].char_val),temp);free(temp);sprintf((yyval.char_val),"%s %s %s %s %s %s %s %s %s",(yyvsp[-8].char_val),(yyvsp[-7].char_val),(yyvsp[-6].char_val),(yyvsp[-5].char_val),(yyvsp[-4].char_val),(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2046 "lab2.tab.c"
    break;

  case 74:
#line 224 "lab2.y"
                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 2052 "lab2.tab.c"
    break;

  case 75:
#line 226 "lab2.y"
                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 2058 "lab2.tab.c"
    break;

  case 76:
#line 228 "lab2.y"
                                        {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2064 "lab2.tab.c"
    break;

  case 77:
#line 229 "lab2.y"
                                                        {sprintf((yyval.char_val),"%s %s %s %s",(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2070 "lab2.tab.c"
    break;

  case 78:
#line 231 "lab2.y"
                                {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 2076 "lab2.tab.c"
    break;

  case 79:
#line 232 "lab2.y"
                                                {sprintf((yyval.char_val),"%s %s",(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2082 "lab2.tab.c"
    break;

  case 80:
#line 233 "lab2.y"
                        {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 2088 "lab2.tab.c"
    break;

  case 81:
#line 234 "lab2.y"
                                        {sprintf((yyval.char_val),"%s %s",(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2094 "lab2.tab.c"
    break;

  case 82:
#line 235 "lab2.y"
                                        {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2100 "lab2.tab.c"
    break;

  case 83:
#line 236 "lab2.y"
                                                {sprintf((yyval.char_val),"%s %s %s %s",(yyvsp[-3].char_val),(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2106 "lab2.tab.c"
    break;

  case 84:
#line 237 "lab2.y"
                                {sprintf((yyval.char_val),"%s %s",(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2112 "lab2.tab.c"
    break;

  case 85:
#line 238 "lab2.y"
                                                {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2118 "lab2.tab.c"
    break;

  case 86:
#line 239 "lab2.y"
                                {sprintf((yyval.char_val),"%s %s",(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2124 "lab2.tab.c"
    break;

  case 87:
#line 240 "lab2.y"
                                                {sprintf((yyval.char_val),"%s %s %s",(yyvsp[-2].char_val),(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2130 "lab2.tab.c"
    break;

  case 88:
#line 241 "lab2.y"
                                        {sprintf((yyval.char_val),"%s %s",(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2136 "lab2.tab.c"
    break;

  case 89:
#line 242 "lab2.y"
                                        {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 2142 "lab2.tab.c"
    break;

  case 90:
#line 243 "lab2.y"
                                        {sprintf((yyval.char_val),"%s %s",(yyvsp[-1].char_val),(yyvsp[0].char_val));}
#line 2148 "lab2.tab.c"
    break;

  case 91:
#line 244 "lab2.y"
                                        {sprintf((yyval.char_val),"%s",(yyvsp[0].char_val));}
#line 2154 "lab2.tab.c"
    break;


#line 2158 "lab2.tab.c"
