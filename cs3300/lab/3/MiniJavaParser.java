...
public class MiniJavaParser implements MiniJavaParserConstants {
  ...
  static final public MethodDeclaration MethodDeclaration() throws ParseException {
   ...
   Token n21;
    ...
    n21 = jj_consume_token(RBRACE);
     ...
     {if (true) return new MethodDeclaration(n0,n1,n2,n3,n5,n7,n9,n11,n13,n15,n17,n18,n20);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public AccessType AccessType() throws ParseException {
   NodeChoice n0;
   PublicType n1;
   PrivateType n2;
   ProtectedType n3;
    ...
    default:
     ...
     {if (true) return new AccessType(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public PublicType PublicType() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(PUBLIC);
                 n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new PublicType(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public PrivateType PrivateType() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(PRIVATE);
                  n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new PrivateType(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public ProtectedType ProtectedType() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(PROTECTED);
                    n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new ProtectedType(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public TernaryExpression TernaryExpression() throws ParseException {
   ...
   PrimaryExpression n6;
    ...
    n6 = PrimaryExpression();
     {if (true) return new TernaryExpression(n0,n1,n3,n4,n6);}
    throw new Error("Missing return statement in function");
  }
